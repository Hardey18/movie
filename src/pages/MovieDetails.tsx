                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <button
                        ...
                        className="mb-2 rounded bg-[#ff0000] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg flex items-center justify-center"
                      >
                        <span className="[&>svg]:h-4 [&>svg]:w-4 mr-4">
                          <svg
